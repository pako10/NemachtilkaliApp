...
public class VozMapacheNahuatlActivity extends AppCompatActivity {
    Button btSig;
    TextView tvPalabra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voz_mapache_nahuatl);
        ...
        btSig.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(VozMapacheNahuatlActivity.this,FelicitacionActivity.class);
                startActivity(i);
            }
        });
    }
...
//Mostramos en pantalla el texto obtenido de la posición 0.
        if (resultcode == Activity.RESULT_OK && datos!=null)
        {
            ...
            if(text.get(0).equals("mapa Chile")||text.get(0).equals("mapa chile")||text.get(0).equals("mapa chile")||text.get(0).equals("mapache")||
                    text.get(0).equals("mapachito")||text.get(0).equals("mapa chicle")||text.get(0).equals("mapa Chicle")||text.get(0).equals("mapache club")){
                Toast.makeText(VozMapacheNahuatlActivity.this, "Correcto", Toast.LENGTH_SHORT).show();
                btSig.setVisibility(View.VISIBLE);
            }else {
                Toast.makeText(VozMapacheNahuatlActivity.this, "Incorrecto,prueba de nuevo", Toast.LENGTH_SHORT).show();
